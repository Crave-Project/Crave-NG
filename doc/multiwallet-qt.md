...
In order to support loading of multiple wallets in crave-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is crave.cpp.
...
Changes to crave.cpp
----------------------
crave.cpp is the entry point into crave-qt, and as such, will require some minor modifications to provide hooks for
