...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/Crave-Project/Crave/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/crave-project/gitian.sigs.git
    git clone https://github.com/crave-project/crave-detached-sigs.git
...
- Detached signatures will then be committed to the [crave-detached-sigs](https://github.com/Crave-Project/crave-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the crave.org server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Crave-Project/Crave/releases/new) with a link to the archived release notes.
