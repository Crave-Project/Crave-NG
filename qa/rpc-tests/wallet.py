...
#   c) node1 mines 32 blocks, so now node 0 has 60001 crave, node 1 has 4250 crave, node2 has none.
#   d) node0 sends 601 crave to node2, in two transactions (301 crave, then 300 crave).
