                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Crave from zCRAVE"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCRAVE"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCRAVE));
