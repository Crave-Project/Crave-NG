...
The Crave project operates an open contributor model where anyone is
...
The following applies to code changes to the Crave project, and is not to be
confused with overall Crave Network Protocol consensus changes.

Whether a pull request is merged into Crave rests with the project merge
...
Patches that change Crave consensus rules are considerably more involved than
...
Where a patch set proposes to change the Crave consensus, it must have been
...
The project leader is the release manager for each Crave release.
